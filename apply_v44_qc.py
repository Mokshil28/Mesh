#!/usr/bin/env python3
"""Apply V44 manual QC: cut fall clips from user-provided timestamps."""
import json
import re
import subprocess
import sys
...
MANUAL_CLIPS = [
    ("0:24", "0:27", "v44 user manual"),
    ("1:01", "1:03", "v44 user manual"),
    ("1:08", "1:11", "v44 user manual"),
    ("7:12", "7:15", "v44 user manual"),
    ("8:08", "8:12", "v44 user manual"),
    ("12:03", "12:07", "v44 user manual"),
    ("12:21", "12:24", "v44 user manual"),
    ("13:22", "13:26", "v44 user manual"),
    ("14:33", "14:37", "v44 user manual"),
    ("14:40", "14:43.5", "v44 user manual"),
    ("15:03", "15:07", "v44 user manual"),
    ("15:08", "15:12", "v44 user manual"),
    ("15:22", "15:25", "v44 user manual"),
    ("15:26", "15:29", "v44 user manual"),
    ("16:02", "16:05", "v44 user manual"),
    ("16:37", "16:40", "v44 user manual"),
    ("17:27", "17:29.8", "v44 user manual"),
    ("18:43", "18:46", "v44 user manual"),
    ("19:12", "19:16", "v44 user manual"),
    ("19:28", "19:31", "v44 user manual"),
    ("19:34.5", "19:37.5", "v44 user manual"),
    ("19:50", "19:53", "v44 user manual"),
    ("19:59", "20:03", "v44 user manual"),
    ("23:00", "23:04", "v44 user manual"),
    ("23:08", "23:11", "v44 user manual"),
    ("23:16", "23:19.6", "v44 user manual"),
    ("23:49", "23:53", "v44 user manual"),
    ("26:28", "26:31", "v44 user manual"),
    ("26:35", "26:38", "v44 user manual"),
    ("27:05", "27:09", "v44 user manual"),
    ("27:57", "28:00", "v44 user manual"),
    ("29:18", "29:22", "v44 user manual"),
    ("29:28", "29:32", "v44 user manual"),
    ("29:36", "29:39", "v44 user manual"),
    ("30:46", "30:49", "v44 user manual"),
    ("30:51", "30:54", "v44 user manual"),
    ("34:04", "34:07", "v44 user manual"),
    ("34:16", "34:19", "v44 user manual"),
    ("38:37", "38:40", "v44 user manual"),
    ("38:42", "38:44", "v44 user manual"),
]

START_AFTER_CAMERA = {21, 35, 40}

YOUTUBE_URL = "https://www.youtube.com/watch?v=S8o2t93DsKQ"
...
def main():
    folder = Path(sys.argv[1]) if len(sys.argv) > 1 else Path(
        "data/fall_dataset_clips/044_V44"
    )
    ...
    print(f"Cutting {len(manual)} V44 clips @ {fps:.3f} fps")
    ok = 0
    for entry in manual:
