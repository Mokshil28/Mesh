#!/usr/bin/env python3
"""Apply V46 manual QC: cut fall clips from user-provided timestamps."""
import json
import re
import subprocess
import sys
...
MANUAL_CLIPS = [
    ("1:55", "1:59", "v46 user manual"),
    ("2:54", "2:58", "v46 user manual"),
    ("11:44", "11:48", "v46 user manual"),
    ("12:14", "12:18", "v46 user manual"),
    ("14:47", "14:51", "v46 user manual"),
    ("15:06", "15:09", "v46 user manual"),
    ("15:57", "16:01", "v46 user manual"),
    ("17:31", "17:34", "v46 user manual"),
    ("17:58", "18:02", "v46 user manual"),
    ("18:10", "18:13", "v46 user manual — cut before camera cut"),
    ("19:18", "19:22", "v46 user manual"),
    ("19:41", "19:43", "v46 user manual"),
    ("20:08", "20:12", "v46 user manual"),
    ("20:42", "20:46", "v46 user manual"),
    ("21:08", "21:12", "v46 user manual"),
    ("22:33", "22:37", "v46 user manual"),
    ("23:22", "23:26", "v46 user manual"),
    ("23:42", "23:46", "v46 user manual"),
    ("26:16", "26:19", "v46 user manual"),
    ("26:47", "26:50", "v46 user manual"),
    ("26:57", "27:00", "v46 user manual"),
    ("28:50", "28:53.8", "v46 user manual"),
]

END_BEFORE_CAMERA = {10}

YOUTUBE_URL = "https://www.youtube.com/watch?v=uUJb5NPbBHQ"
...
def main():
    folder = Path(sys.argv[1]) if len(sys.argv) > 1 else Path(
        "data/fall_dataset_clips/046_V46"
    )
    ...
    print(f"Cutting {len(manual)} V46 clips @ {fps:.3f} fps")
    ok = 0
    for entry in manual:
