#!/usr/bin/env python3
"""Apply V53 manual QC: cut fall clips from user-provided timestamps."""
import json
import re
import subprocess
import sys
...
MANUAL_CLIPS = [
    ("0:16", "0:20", "v53 user manual"),
    ("2:32", "2:33", "v53 user manual"),
    ("2:40", "2:43", "v53 user manual"),
    ("3:52", "3:56", "v53 user manual"),
    ("6:39", "6:43", "v53 user manual - cut before camera cut"),
    ("8:18", "8:21", "v53 user manual"),
    ("8:27", "8:29", "v53 user manual"),
    ("8:31", "8:33", "v53 user manual"),
    ("10:02", "10:05", "v53 user manual"),
    ("10:47", "10:51", "v53 user manual"),
    ("11:36", "11:39", "v53 user manual"),
    ("14:17", "14:19", "v53 user manual"),
    ("15:09", "15:12", "v53 user manual"),
    ("15:45", "15:48", "v53 user manual"),
    ("16:20", "16:24", "v53 user manual"),
    ("17:07", "17:11", "v53 user manual"),
    ("18:33", "18:37", "v53 user manual"),
    ("20:02", "20:05", "v53 user manual - cut before camera cut"),
    ("24:24", "24:28", "v53 user manual"),
]

END_BEFORE_CAMERA = {5, 18}

YOUTUBE_URL = "https://www.youtube.com/watch?v=YyyCh_BkyU0"
...
def main():
    folder = Path(sys.argv[1]) if len(sys.argv) > 1 else Path(
        "data/fall_dataset_clips/053_V53"
    )
    ...
    print(f"Cutting {len(manual)} V53 clips @ {fps:.3f} fps")
    ok = 0
    for entry in manual:
