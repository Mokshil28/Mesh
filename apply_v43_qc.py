#!/usr/bin/env python3
"""Apply V43 manual QC: cut fall clips from user-provided timestamps."""
import json
import re
import subprocess
import sys
...
MANUAL_CLIPS = [
    ("0:00", "0:03.5", "v43 user manual"),
    ("1:40", "1:44", "v43 user manual"),
    ("2:22", "2:26", "v43 user manual"),
    ("4:56", "5:00", "v43 user manual"),
    ("5:40", "5:44", "v43 user manual"),
    ("6:22", "6:26", "v43 user manual"),
    ("6:36", "6:40", "v43 user manual"),
    ("10:39", "10:42", "v43 user manual"),
    ("15:14", "15:18", "v43 user manual"),
    ("17:56", "18:00", "v43 user manual"),
    ("18:04", "18:08", "v43 user manual"),
    ("19:40", "19:44", "v43 user manual"),
    ("20:21", "20:23.5", "v43 user manual"),
    ("20:27", "20:30", "v43 user manual"),
    ("20:40", "20:44", "v43 user manual"),
    ("21:21", "21:24", "v43 user manual"),
    ("25:20", "25:23", "v43 user manual — cut at 3 sec"),
    ("28:32", "28:36", "v43 user manual"),
]

START_AFTER_CAMERA = {16}

YOUTUBE_URL = "https://www.youtube.com/watch?v=Zu8T8Lac8Gg"
...
def main():
    folder = Path(sys.argv[1]) if len(sys.argv) > 1 else Path(
        "data/fall_dataset_clips/043_V43"
    )
    ...
    print(f"Cutting {len(manual)} V43 clips @ {fps:.3f} fps")
    ok = 0
    for entry in manual:
